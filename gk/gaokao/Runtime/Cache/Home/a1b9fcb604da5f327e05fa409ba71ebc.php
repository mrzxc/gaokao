...
<html lang="zh-CN">
  <head>
    ...
    <link href="/gaokao/Public/css/inqure.css" rel="stylesheet">
  ...
  <header><ul>
    ...
    <nav class="navbar navbar-static-top " role="navgation">
      ...
      <div class="form text-center container">
        ...
        <div class="row sub_button form-group">
          <div class="col-md-6 col-xs-6">
            <button id="SchoolRefer" class="btn btn-default">查询学校</button>
          </div>
          <div class="col-md-6 col-xs-6">
            <button id="SpecialRefer" class="btn btn-default" >查询专业</button>
          </div>
          <p class="col-md-2" id="warning"></p>
        </div>
